...
```hcl
module "http_sg" {
  source = "terraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/awsterraform-aws-modules/security-group/aws"
  # omitted for brevity
}
...
| <a name="input_use_name_prefixinput_use_name_prefixinput_use_name_prefixinput_use_name_prefix"></a> [use\_name\_prefix](#input\_use\_name\_prefix) | Whether to use name\_prefix or fixed name. Should be true to able to update security group name after initial creation | `bool` | `true` | no |
